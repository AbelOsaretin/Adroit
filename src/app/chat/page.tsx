  ...
  return (
    <div className="relative size-full h-screen w-full p-6">
      <div className="flex h-full flex-col">
        <div className="mb-4">
          <h1 className="text-2xl font-bold">Adroit Marketing Assistant</h1>
          <p className="text-muted-foreground">
            Your AI-powered marketing agency for small businesses
          </p>
        </div>
            ...
            {messages.length === 0 && (
              <div className="flex flex-col items-center justify-center h-full text-center">
                <div className="max-w-md space-y-4">
                  <h2 className="text-xl font-semibold">Welcome to Adroit</h2>
                  <p className="text-muted-foreground">
                    I can help you with marketing strategy, content creation, SEO analysis,
                    and social media management. What would you like to work on today?
                  </p>
        ...
        <PromptInput onSubmit={handleSubmit} className="mt-4">
          <PromptInputBody>
            <PromptInputTextarea
              ...
              value={input}
              placeholder="Ask me about marketing strategy, content creation, SEO, or social media..."
