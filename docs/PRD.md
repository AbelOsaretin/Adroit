...
- **Google Ads MCP Server** — real API integration for campaign management
- **Meta Ads MCP Server** — real API integration for Facebook/Instagram ads
...
- **Cross-platform Analytics** — compare Google vs Meta performance
